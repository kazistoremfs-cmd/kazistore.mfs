    ...
    <footer className="relative z-10 bg-slate-900 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            <div className="flex flex-col mb-4">
              ...
              <span className="text-[10px] text-slate-300 font-bold uppercase tracking-[0.2em] font-en mt-1">MFS Agent Point</span>
            </div>
            <p className="text-slate-300 font-bn text-sm leading-relaxed max-w-sm">
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-400 font-en text-xs">
            © {new Date().getFullYear()} Kazi Store. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-slate-400 font-bn text-xs">
