...
export default function HSCDetails() {
    ...
    <div className="relative min-h-[calc(100vh-64px)] bg-[#0F172A] overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col w-full max-w-4xl mx-auto md:px-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-slate-400 p-4 md:pt-12 md:px-0 font-en backdrop-blur-md bg-[#0F172A]/50 md:bg-transparent sticky top-0 z-20 border-b border-slate-800 md:border-none">
          ...
          <span className="text-white font-medium truncate">HSC রেজাল্ট ও বোর্ড চ্যালেঞ্জ</span>
        </nav>
        ...
        >
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-bn text-white mb-3 md:mb-4 tracking-tight drop-shadow-md">
              HSC রেজাল্ট ও বোর্ড চ্যালেঞ্জ
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-slate-300 font-bn leading-relaxed max-w-2xl whitespace-pre-line drop-shadow mb-6">
              HSC পরীক্ষার রেজাল্ট দেখা, মার্কশিট ডাউনলোড এবং বোর্ড চ্যালেঞ্জ সংক্রান্ত সকল সেবা আমাদের কাজী স্টোর থেকে প্রদান করা হয়।
            </p>

            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-5 backdrop-blur-sm">
              <h3 className="text-lg md:text-xl font-bold text-orange-400 font-bn mb-2 flex items-center gap-2">
                <FileText className="w-5 h-5" /> বিজ্ঞপ্তি / Note
              </h3>
              <p className="text-[15px] md:text-base text-orange-200/90 font-bn leading-relaxed">
                HSC পরীক্ষার ফলাফল প্রকাশের তারিখ এখনো আনুষ্ঠানিকভাবে ঘোষণা করা হয়নি। ফলাফল প্রকাশের নির্দিষ্ট তারিখে বোর্ড চ্যালেঞ্জ ও অন্যান্য কার্যক্রমের বিস্তারিত তথ্য এই পেজে আপডেট করা হবে। 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-4 sm:p-6 backdrop-blur-md shadow-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white font-bn">HSC রেজাল্ট দেখার নিয়ম</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-900/40 p-5 rounded-xl border border-slate-700/30">
                  ...
                  <div className="bg-slate-800 p-3 rounded-lg border border-slate-700 font-en text-sm text-emerald-400 mb-3 overflow-x-auto whitespace-nowrap">
                    HSC &lt;Space&gt; [1st 3 letters of Board] &lt;Space&gt; [Roll] &lt;Space&gt; [Year]
                  </div>
                  ...
                  <p className="font-bn text-sm text-slate-400 mt-3 pt-3 border-t border-slate-700/50">উদাহরণ: HSC DHA 123456 2026</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-4 sm:p-6 backdrop-blur-md shadow-xl flex flex-col justify-center">
                ...
                <p className="font-bn text-[15px] md:text-base text-slate-300 leading-relaxed mb-5">
                  HSC ফলাফল প্রকাশের পরবর্তী <strong className="text-white">৭ দিন</strong> ফল পুনঃনিরীক্ষণের আবেদন চলবে এবং HSC ফলাফল প্রকাশের <strong className="text-white">৩০ দিন</strong> পর পুনঃনিরীক্ষণের ফল প্রকাশিত হবে।
                </p>
