...
export const servicesData = serviceCategories.flatMap(cat => 
  cat.items.map(item => {
    ...
    if (item.id === 'mfs-bkash') {
      ...
      customFaqs = [
        ...
        },
        {
          ...
          a: 'বিটিআরসি (BTRC)-এর সরকারি নির্দেশনা অনুযায়ী একটি NID দিয়ে সকল অপারেটর মিলিয়ে সর্বোচ্চ ১৫টি সিম নিবন্ধন করা যায়।'
        },
        {
    ...
    if (item.id === 'mfs-nagad') {
      ...
      customDesc = 'বাংলাদেশের সকল জনপ্রিয় মোবাইল অপারেটরের (গ্রামীনফোন, বাংলালিংক, রবি, এয়ারটেল, টেলিটক) নতুন ৪জি/৫জি রেডি প্রিপেইড ও পোস্টপেইড সিম কাজী স্টোরে পাওয়া যাচ্ছে। আপনার জাতীয় পরিচয়পত্র (NID) দিয়ে সরকারি নিয়মে ১০০% নিরাপদ বায়োমেট্রিক রেজিস্ট্রেশন করে মুহূর্তেই বুঝে নিন আপনার পছন্দের নতুন সিম ও আকর্ষণীয় নিউ সিম অফার!';
      importantLinks = [
    ...
    if (item.id === 'credit-card') {
      ...
      corners = [
        {
          title: "গ্রামীনফোন (Grameenphone - GP)",
          content: "দেশের শীর্ষস্থানীয় ও শক্তিশালী নেটওয়ার্কের গ্রামীনফোন নতুন প্রিপেইড ৪জি/৫জি রেডি সিম। নতুন সিমে পাচ্ছেন আকর্ষণীয় ওয়েলকাম ইন্টারনেট ও মিনিট বান্ডেল অফার, নির্দিষ্ট রিচার্জে ক্যাশব্যাক ও ফ্রি ডাটা সুবিধা। স্পেশাল ও ভিআইপি নম্বর কালেকশনও পাওয়া যাবে।",
          link: "/sim/gp"
        },
        {
