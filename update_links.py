...
search = """                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                              ...
                              {corner.link && (
                                <div className="flex justify-end sm:shrink-0">
                                  <Link 
                                    to={corner.link}
                                    className="inline-flex items-center gap-2 bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 border border-blue-500/30 px-4 py-2.5 rounded-lg text-sm font-bold transition-all font-bn shadow-lg hover:scale-105 active:scale-95"
                                  >
                                    বিস্তারিত
                                  </Link>
                                </div>
...
replace = """                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
